...
pub(crate) fn get_sprite_challenge(sprite_id: &SpriteId) -> SpriteChallenge {
    ...
    match sprite_id {
        SpriteId::x0_RAVEN => SpriteChallenge::X1Easiest,
        SpriteId::x1_VULTURE => SpriteChallenge::X1Easiest,
        ...
        SpriteId::x15_ANTIFAIRY => SpriteChallenge::X1Easiest,
        ...
        SpriteId::x41_BLUE_GUARD => SpriteChallenge::X5Hard,
        ...
        SpriteId::x45_BLACK_SPEAR_GUARD => SpriteChallenge::X7Hardest,
        SpriteId::x46_BLUE_ARCHER => SpriteChallenge::X5Hard,
        SpriteId::x47_GREEN_GUARD_BUSH => SpriteChallenge::X3Easier,
        SpriteId::x48_RED_JAVELIN_GUARD => SpriteChallenge::X6Harder,
        SpriteId::x49_RED_GUARD_BUSH => SpriteChallenge::X5Hard,
        SpriteId::x4A_RED_BOMB_GUARD => SpriteChallenge::X6Harder,
        ...
        SpriteId::x5D_ROLLER_SOUTH => SpriteChallenge::X3Easier,
        SpriteId::x5E_ROLLER_NORTH => SpriteChallenge::X3Easier,
        SpriteId::x5F_ROLLER_EAST => SpriteChallenge::X3Easier,
        SpriteId::x60_ROLLER_WEST => SpriteChallenge::X3Easier,
        ...
        SpriteId::x6B_CANNON_GUARD => SpriteChallenge::X2Easy,
        ...
        SpriteId::x77_ANTIFAIRY_2 => SpriteChallenge::X2Easy,
        SpriteId::x79_BEE => SpriteChallenge::X7Hardest,
        SpriteId::x7A_AGAHNIM => SpriteChallenge::X3Easier,
        SpriteId::x7C_GREEN_STALFOS => SpriteChallenge::X4Medium,
        ...
        SpriteId::xA5_BLUE_ZAZAK => SpriteChallenge::X4Medium,
        SpriteId::xA6_RED_ZAZAK => SpriteChallenge::X5Hard,
        SpriteId::xA7_STALFOS => SpriteChallenge::X4Medium,
        ...
        SpriteId::xC5_MEDUSA => SpriteChallenge::X3Easier,
        SpriteId::xC6_MEDUSA_FOUR_WAY => SpriteChallenge::X4Medium,
        SpriteId::xC7_POKEY => SpriteChallenge::X4Medium,
        ...
        SpriteId::xD1_BUNNY_BEAM => SpriteChallenge::X4Medium,
        SpriteId::xD3_STAL => SpriteChallenge::X1Easiest,
        SpriteId::xD4_LANDMINE => SpriteChallenge::X1Easiest,
