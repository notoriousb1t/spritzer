...
class SpriteVulnerability(Enum):
    INVULNERABLE = 1
    ANY = 2
    BOW = 3
    HAMMER = 4
...
_sprite_settings: Dict[SpriteId, SpriteSettings] = {
    ...
    SpriteId.x5F_ROLLER: SpriteSettings(role=SpriteType.ENEMY),
...
class Sprite:
    ...
    def set_invisible(self) -> None:
        self.flags_0 &= ~(
            Flags0.DISPLAY_0 | Flags0.DISPLAY_1 | Flags0.DISPLAY_2 | Flags0.DISPLAY_3
        )

    def set_invincible(self) -> None:
        self.flags_3 |= Flags3.INVINCIBLE
