...
class SpriteConfiguration:
    ...
    movement: Union[SpriteMovement, None]
    """The possible movements for this sprite. This was created largely for hazards."""

    def __init__(
        self,
        role: SpriteType = SpriteType.UNSPECIFIED,
        is_aquatic: bool = False,
        is_flying: bool = False,
        vulnerability: Union[SpriteVulnerability, None] = None,
        can_shuffle: Union[bool, None] = None,
        can_shuffle_in_area: Union[bool, None] = None,
        can_shuffle_in_room: Union[bool, None] = None,
        can_hold_key: Union[bool, None] = None,
        movement: Union[SpriteMovement, None] = None,
    ) -> None:
        self.role = role
