//! 0f200b44e6f87a46b658564e54eec703ee1b9e548a73f8d557e5db22699f6461
...
pub fn get_patch_data() -> Vec<(usize, Vec<u8>)> {
  vec![
    ...
    (0x9DB19, vec![
        0x14, 0x07, 0x84, 0x1C, 0x03, 0xB8, 0x1C, 0x0C, 
        0xB8, 
    ]),
    (0x9DEEB, vec![
        0x04, 0x07, 0x84, 
    ...
    (0x9DEF4, vec![
        0x08, 0x04, 0xB8, 0x08, 0x0B, 0xB8, 
    ]),
    (0x9E199, vec![
        0x06, 0x0A, 0xB8, 0x09, 0x06, 0x84, 
    ]),
    (0x9E1A5, vec![
        0x18, 0x03, 0xB8, 
    ]),
    ...
    (0x1DD88E, vec![
        0x22, 0x7C, 0x80, 0x36, 0xEA, 0xEA, 0xEA, 0xEA, 
        0xEA, 0xEA, 0xEA, 0xEA, 
    ]),
    (0x1DDBB3, vec![
        0x07, 
    ...
    (0x368000, vec![
        ...
        0x80, 0xA9, 0x83, 0x9D, 0x20, 0x0E, 0xBD, 0x20, 
