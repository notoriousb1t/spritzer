...
class SpritesetId(IntEnum):
    ...
    x2C_UNDERWORLD_FREESPACE = 43 + _room_gfx_offset
    x2D_UNDERWORLD_FREESPACE = 44 + _room_gfx_offset
    x2E_UNDERWORLD_FREESPACE = 45 + _room_gfx_offset
    x2F_UNDERWORLD_FREESPACE = 46 + _room_gfx_offset
    x30_UNDERWORLD_FREESPACE = 47 + _room_gfx_offset
    x31_UNDERWORLD_FREESPACE = 48 + _room_gfx_offset
    x32_UNDERWORLD_FREESPACE = 49 + _room_gfx_offset
    x33_UNDERWORLD_FREESPACE = 50 + _room_gfx_offset
    x34_UNDERWORLD_FREESPACE = 51 + _room_gfx_offset
    x35_UNDERWORLD_FREESPACE = 52 + _room_gfx_offset
    x36_UNDERWORLD_FREESPACE = 53 + _room_gfx_offset
    x37_UNDERWORLD_FREESPACE = 54 + _room_gfx_offset
    x38_UNDERWORLD_FREESPACE = 55 + _room_gfx_offset
    x39_UNDERWORLD_FREESPACE = 56 + _room_gfx_offset
    x3A_UNDERWORLD_FREESPACE = 57 + _room_gfx_offset
    x3B_UNDERWORLD_FREESPACE = 58 + _room_gfx_offset
    x3C_UNDERWORLD_FREESPACE = 59 + _room_gfx_offset
    x3D_UNDERWORLD_FREESPACE = 60 + _room_gfx_offset
