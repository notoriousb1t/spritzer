...
_sprite_configuration: Dict[SpriteId, SpriteConfiguration] = {
    SpriteId.x0_CROW: SpriteConfiguration(is_flying=True, role=SpriteType.ENEMY),
    SpriteId.x1_VULTURE: SpriteConfiguration(is_flying=True, role=SpriteType.ENEMY),
    SpriteId.x2_FLYING_STALFOS_HEAD: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x3_EMPTY: SpriteConfiguration(),
    SpriteId.x4_PULL_SWITCH_GOOD: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x5_PULL_SWITCH_UNUSED_1: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x6_PULL_SWITCH_TRAP: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x7_PULL_SWITCH_UNUSED_2: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x8_OCTOROK_ONE_WAY: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x9_MOLDORM_BOSS: SpriteConfiguration(role=SpriteType.BOSS),
    ...
    SpriteId.x14_GARGOYLES_DOMAIN_GATE: SpriteConfiguration(role=SpriteType.OBJECT),
    ...
    SpriteId.x17_BUSH_HOARDER: SpriteConfiguration(
    ...
    SpriteId.x1A_DWARVES: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x1B_ARROW_IN_WALL: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x1C_STATUE: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x1D_WEATHERVANE: SpriteConfiguration(role=SpriteType.OBJECT),
    ...
    SpriteId.x21_PUSH_SWITCH: SpriteConfiguration(role=SpriteType.OBJECT),
    ...
    SpriteId.x28_STORYTELLERS: SpriteConfiguration(role=SpriteType.NPC),
    ...
    SpriteId.x2D_TELEPATHIC_STONES: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x2E_FLUTE_BOYS_NOTES: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x2F_RACE_HP_NPCS: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x30_PERSON: SpriteConfiguration(role=SpriteType.NPC),
    ...
    SpriteId.x33_PULL_FOR_RUPEES: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x34_SCARED_GIRL: SpriteConfiguration(role=SpriteType.NPC),
    ...
    SpriteId.x38_ARROW_TARGET: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x39_AVERAGE_MIDDLE_AGED_MAN: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x3A_HALF_MAGIC_BAT: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x3B_DASH_ITEM: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x3C_VILLAGE_KID: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x3D_SCARED_LADIES_OUTSIDE_HOUSES: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x3E_ROCK_HOARDER: SpriteConfiguration(
        can_hold_key=False, role=SpriteType.ENEMY
    ),
    ...
    SpriteId.x41_BLUE_SWORD_SOLDIER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x42_GREEN_SWORD_SOLDIER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x43_RED_SPEAR_SOLDIER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x44_ASSAULT_SWORD_SOLDIER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x45_GREEN_SPEAR_SOLDIER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x46_BLUE_ARCHER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x47_GREEN_ARCHER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x48_RED_JAVELIN_SOLDIER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x49_RED_JAVELIN_SOLDIER_2: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x4A_RED_BOMB_SOLDIERS: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x4B_GREEN_SOLDIER_RECRUITS: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x4C_GELDMAN: SpriteConfiguration(role=SpriteType.ENEMY, can_hold_key=False),
    ...
    SpriteId.x50_CANNON_BALLS: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x51_ARMOS: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x52_GIANT_ZORA: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x53_ARMOS_KNIGHTS_BOSS: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.x54_LANMOLAS_BOSS: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.x55_FIREBALL_ZORA: SpriteConfiguration(
        is_aquatic=True,
        role=SpriteType.ENEMY,
    ),
    SpriteId.x56_WALKING_ZORA: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x57_DESERT_PALACE_BARRIERS: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x58_CRAB: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x59_BIRD: SpriteConfiguration(role=SpriteType.CREATURE),
    SpriteId.x5A_SQUIRREL: SpriteConfiguration(role=SpriteType.CREATURE),
    ...
    SpriteId.x5D_ROLLER_VERTICAL_MOVING_1: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.VERTICAL,
    ),
    SpriteId.x5E_ROLLER_VERTICAL_MOVING_2: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.VERTICAL,
    ),
    SpriteId.x5F_ROLLER: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.HORIZONTAL,
    ),
    SpriteId.x60_ROLLER_HORIZONTAL_MOVING: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.HORIZONTAL,
    ),
    ...
    SpriteId.x62_MASTER_SWORD: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x63_DEVALANT_NON_SHOOTER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x64_DEVALANT_SHOOTER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x65_ARCHERY_GUY: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x66_MOVING_CANNON_BALL_SHOOTERS_RIGHT: SpriteConfiguration(
        can_shuffle_in_room=False,
        role=SpriteType.HAZARD,
        movement=SpriteMovement.EAST,
    ),
    SpriteId.x67_MOVING_CANNON_BALL_SHOOTERS_LEFT: SpriteConfiguration(
        can_shuffle_in_room=False,
        role=SpriteType.HAZARD,
        movement=SpriteMovement.WEST,
    ),
    SpriteId.x68_MOVING_CANNON_BALL_SHOOTERS_DOWN: SpriteConfiguration(
        can_shuffle_in_room=False,
        role=SpriteType.HAZARD,
        movement=SpriteMovement.WEST,
    ),
    SpriteId.x69_MOVING_CANNON_BALL_SHOOTERS_UP: SpriteConfiguration(
        can_shuffle_in_room=False,
        role=SpriteType.HAZARD,
        movement=SpriteMovement.NORTH,
    ),
    SpriteId.x6A_BALL_N_CHAIN_TROOPER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x6B_CANNON_SOLDIER: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x6C_MIRROR_PORTAL: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x6D_RAT: SpriteConfiguration(role=SpriteType.ENEMY),
    ...
    SpriteId.x72_FAIRY_POND_ITEM_TRIGGER: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x73_UNCLE_PRIEST: SpriteConfiguration(role=SpriteType.NPC),
    ...
    SpriteId.x76_PRINCESS_ZELDA: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.x77_ANTIFAIRY_ALTERNATE: SpriteConfiguration(
        vulnerability=SpriteVulnerability.INVULNERABLE,
        role=SpriteType.ENEMY,
        can_shuffle_in_room=False,
        movement=SpriteMovement.DIAGONAL,
    ...
    SpriteId.x7C_FLOATING_STALFOS_HEAD: SpriteConfiguration(
        is_flying=True,
        vulnerability=SpriteVulnerability.INVULNERABLE,
        role=SpriteType.ENEMY,
    ),
    SpriteId.x7D_BIG_SPIKE_TRAP: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.HORIZONTAL | SpriteMovement.VERTICAL,
    ),
    SpriteId.x7E_GURUGURU_BAR_CLOCKWISE: SpriteConfiguration(
        role=SpriteType.HAZARD, movement=SpriteMovement.FIXED
    ),
    SpriteId.x7F_GURUGURU_BAR_COUNTER_CLOCKWISE: SpriteConfiguration(
        role=SpriteType.HAZARD, movement=SpriteMovement.FIXED
    ),
    SpriteId.x80_WINDER: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.SNAKE,
    ),
    SpriteId.x81_WATER_TEKTITE: SpriteConfiguration(is_aquatic=True, role=SpriteType.ENEMY),
    ...
    SpriteId.x86_KODONGOS: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x87_FLAMES: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x88_MOTHULA_BOSS: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.x89_MOTHULAS_BEAM: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.x8A_SPIKE_TRAP: SpriteConfiguration(
        role=SpriteType.HAZARD, movement=SpriteMovement.HORIZONTAL
    ),
    SpriteId.x8B_GIBDO: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x8C_ARRGHUS_BOSS: SpriteConfiguration(role=SpriteType.BOSS),
    ...
    SpriteId.x8F_SLIME: SpriteConfiguration(role=SpriteType.ENEMY),
    ...
    SpriteId.x92_HELMASAUR_KING: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.x93_BUMPER: SpriteConfiguration(
        can_shuffle_in_room=False, role=SpriteType.HAZARD, movement=SpriteMovement.FIXED
    ),
    SpriteId.x94_SWIMMERS_EVIL: SpriteConfiguration(is_aquatic=True, role=SpriteType.ENEMY),
    SpriteId.x95_EYE_LASER_RIGHT: SpriteConfiguration(
        role=SpriteType.HAZARD, movement=SpriteMovement.EAST
    ),
    SpriteId.x96_EYE_LASER_LEFT: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.WEST,
    ),
    SpriteId.x97_EYE_LASER_DOWN: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.SOUTH,
    ),
    SpriteId.x98_EYE_LASER_UP: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.NORTH,
    ),
    SpriteId.x99_PENGATOR: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x9A_KYAMERON_WATER_SPLASH: SpriteConfiguration(
        is_aquatic=True,
        role=SpriteType.ENEMY,
        vulnerability=SpriteVulnerability.INVULNERABLE,
    ),
    SpriteId.x9B_WIZZROBE: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.x9C_VERMIN_HORIZONTAL_PIROGUSU: SpriteConfiguration(
        can_hold_key=False,
        role=SpriteType.HAZARD,
        movement=SpriteMovement.HORIZONTAL,
    ),
    SpriteId.x9D_VERMIN_VERTICAL_PIROGUSU: SpriteConfiguration(
        can_hold_key=False,
        role=SpriteType.HAZARD,
        movement=SpriteMovement.VERTICAL,
    ),
    SpriteId.x9E_OSTRICH_HAUNTED_GROVE: SpriteConfiguration(role=SpriteType.CREATURE),
    SpriteId.x9F_FLUTE: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.xA0_BIRDS_HAUNTED_GROVE: SpriteConfiguration(role=SpriteType.CREATURE),
    ...
    SpriteId.xA2_KHOLDSTARE_BOSS: SpriteConfiguration(role=SpriteType.BOSS),
    ...
    SpriteId.xA8_ZIRRO_1: SpriteConfiguration(can_hold_key=False, role=SpriteType.ENEMY),
    SpriteId.xA9_ZIRRO_2: SpriteConfiguration(
        can_hold_key=False, is_flying=True, role=SpriteType.ENEMY
    ),
    SpriteId.xAA_PIKIT: SpriteConfiguration(role=SpriteType.ENEMY),
    SpriteId.xAB_MAIDEN: SpriteConfiguration(role=SpriteType.NPC),
    ...
    SpriteId.xB2_GOOD_BEE_AGAIN: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.xB3_HYLIAN_INSCRIPTION: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.xB4_THIEFS_CHEST_ITEM_TRIGGER: SpriteConfiguration(role=SpriteType.OBJECT),
    ...
    SpriteId.xB7_MAIDEN_IN_BLIND_DUNGEON: SpriteConfiguration(role=SpriteType.NPC),
    SpriteId.xB8_MIMIC: SpriteConfiguration(
        vulnerability=SpriteVulnerability.BOW, role=SpriteType.ENEMY
    ),
    SpriteId.xB9_FEUDING_FRIENDS_ON_DEATH_MOUNTAIN: SpriteConfiguration(role=SpriteType.NPC),
    ...
    SpriteId.xBD_VITREOUS_LARGE_EYEBALL: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.xBE_VITREOUS_SMALL_EYEBALL: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.xBF_VITREOUS_LIGHTNING: SpriteConfiguration(role=SpriteType.BOSS),
    ...
    SpriteId.xC2_BOULDERS: SpriteConfiguration(role=SpriteType.OBJECT),
    ...
    SpriteId.xC6_YOMO_MEDUSA: SpriteConfiguration(
        role=SpriteType.HAZARD,
        movement=SpriteMovement.FIXED
        | SpriteMovement.VERTICAL
        | SpriteMovement.HORIZONTAL,
    ),
    SpriteId.xC7_HOKKU_BOKKU: SpriteConfiguration(role=SpriteType.ENEMY),
    ...
    SpriteId.xCB_TRINEXX_1: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.xCC_TRINEXX_2: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.xCD_TRINEXX_3: SpriteConfiguration(role=SpriteType.BOSS),
    SpriteId.xCE_BLIND_THE_THIEF_BOSS: SpriteConfiguration(role=SpriteType.BOSS),
    ...
    SpriteId.xD8_GREEN_BOMB: SpriteConfiguration(role=SpriteType.CONSUMABLE),
    ...
    SpriteId.xE4_KEY: SpriteConfiguration(role=SpriteType.OBJECT),
    ...
    SpriteId.xEC_BUSHES: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.xED_CANE_OF_SOMARIA_PLATFORM: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.xEE_MANTLE: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.xEF_CANE_OF_SOMARIA_PLATFORM_UNUSED_1: SpriteConfiguration(
        role=SpriteType.OBJECT
    ),
    SpriteId.xF0_CANE_OF_SOMARIA_PLATFORM_UNUSED_2: SpriteConfiguration(
        role=SpriteType.OBJECT
    ),
    SpriteId.xF1_CANE_OF_SOMARIA_PLATFORM_UNUSED_3: SpriteConfiguration(
        role=SpriteType.OBJECT
    ),
    SpriteId.xF2_MEDALLION_TABLET: SpriteConfiguration(role=SpriteType.OBJECT),
    SpriteId.xF3_PERSONS_DOOR_OW_OVERLORD: SpriteConfiguration(role=SpriteType.OVERLORD),
    SpriteId.xF4_FALLING_ROCKS_OW_OVERLORD: SpriteConfiguration(role=SpriteType.OVERLORD),
