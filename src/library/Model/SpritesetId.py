...
def create_spriteset_dict() -> [Dict[SpritesetId, SpritesetId]]:
    ...
    return {
        ...
        SpritesetId.x11_MISCELLANEOUS_2: [
            SpriteId.x0_CROW,
            SpriteId.x17_BUSH_HOARDER,
        ...
        SpritesetId.x28_ZAZAK: [
            SpriteId.xA5_BLUE_ZAZAK,
            SpriteId.xA6_RED_ZAZAK,
            SpriteId.xC3_GIBO,
        ],  # 91=0x5b  99=0x63
        SpritesetId.x29_WIZZROBE: [
            SpriteId.x115_WIZZROBE_SPAWNER,
            SpriteId.x9B_WIZZROBE,
        ],  # 100=0x64
        SpritesetId.x2A_HAZARDS: [
        ...
        SpritesetId.x2B_UNUSED: [],  # 80=0x50
        SpritesetId.x2C_BEAM_ME_UP_MR_POPO: [
            SpriteId.x4E_POPO_1,
            SpriteId.x4F_POPO_2,
            SpriteId.x61_BEAMOS,
        ...
        SpritesetId.x2E_EYEGORE: [
            SpriteId.x83_GREEN_EYEGORE_MIMIC,
            SpriteId.x84_RED_EYEGORE_MIMIC,
        ],  # 72=0x48  73=0x49  74=0x4a  75=0x4b
        SpritesetId.x2F_CANON_CRAB: [
            SpriteId.x58_CRAB,
        ...
        SpritesetId.x53_UNKNOWN: [],  # 81=0x51  102=0x66  105=0x69
        SpritesetId.x55_AGAHNIM: [
            SpriteId.x7A_AGAHNIM,
            SpriteId.xC1_AGAHNIM_TELEPORTING,
            SpriteId.x7B_AGAHNIM_ENERGY_BALL,
            SpriteId.xAB_MAIDEN,
        ...
        SpritesetId.x5A_UNKNOWN: [],  # 69=0x45
        SpritesetId.x5C_UNKNOWN: [],  # 27=0x1b
        SpritesetId.x5D_MANTLE_CREDITS: [
            SpriteId.xEE_MANTLE
